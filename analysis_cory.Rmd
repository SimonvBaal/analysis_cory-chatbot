...
#   ggplot(ComparisonData, aes(x = Attitude, fill = Study_Type)) +
...
HighRiskComparisonData <- 
  ComparisonData %>% filter(Risk == "High_Risk")
HighRiskEqVariancesTest <- 
  levene.test(HighRiskComparisonData$Attitude, HighRiskComparisonData$Study_Type)

LowRiskComparisonData <- 
  ComparisonData %>% filter(Risk == "Low_Risk")
LowRiskEqVariancesTest <- 
  levene.test(LowRiskComparisonData$Attitude, LowRiskComparisonData$Study_Type)

MinimalRiskComparisonData <- 
  ComparisonData %>% filter(Risk == "Minimal_Risk")
MinimalRiskEqVariancesTest <- 
  levene.test(MinimalRiskComparisonData$Attitude, MinimalRiskComparisonData$Study_Type)
