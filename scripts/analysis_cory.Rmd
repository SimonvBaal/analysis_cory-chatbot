...
zValueWTestComp <- 
  wilcoxonZ(x = chatbotData$testingLikNum[chatbotData$Condition == "Compassion"],
              y = chatbotData$testingLikNum[chatbotData$Condition == "Control"],
              paired = F,
              exact = F,
            digits = 4)
...
ZValueWTestExp <-
  wilcoxonZ(x = chatbotData$testingLikNum[chatbotData$Condition == "Exponential Growth"],
              y = chatbotData$testingLikNum[chatbotData$Condition == "Control"],
              paired = F,
              exact = F,
            digits = 4)
...
# Add absolute value for certainty about testing.
...
```{r Continuous Ordinal Model - Attitudes to going out}
# We estimate models with different reference levels, in order to do pairwise
# comparisons.
...
#TimepointPre-Test             -0.057005  0.130388 -0.4372 0.6632508 
...
#                               Estimate    StdErr t.value   p.value
#TimepointPre-Test              0.817518  0.183384  4.4579 2.902e-05 ***
...
#                            Estimate    StdErr t.value   p.value
#TimepointPre-Test           1.238254  0.195481  6.3344 1.682e-08 ***
```
