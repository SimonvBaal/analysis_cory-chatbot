...
#   ggplot(surveyData, aes(x = Attitude, fill = Timepoint)) +
#   geom_density(alpha = .5) +
#   geom_boxplot(aes(x = Attitude, y = TimepointNumeric *-.0015 + 0.0275),
...
# 
 HighRiskAttitudePlot <- 
  ...
  geom_boxplot(aes(x = Attitude, y = TimepointNumeric * .0015 + 0.0215),
               alpha = .4, colour = "black", notch = T, coef = 1) +
